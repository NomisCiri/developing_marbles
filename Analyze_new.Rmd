...
for (agegroup in 1:4){
  logliks_util[[agegroup]]=readRDS(paste0("C_ModelFits/model1_age",agegroup,".rds"))%>%
    loo::extract_log_lik()
  logliks_rewsens[[agegroup]]=readRDS(paste0("C_ModelFits/model2_age",agegroup,".rds"))%>%
    loo::extract_log_lik()
  logliks_bayes[[agegroup]]=readRDS(paste0("C_ModelFits/model3_age",agegroup,".rds"))%>%
    loo::extract_log_lik()
}
...
# investigate model parameters of winning model
```{r}
param_df=NULL
