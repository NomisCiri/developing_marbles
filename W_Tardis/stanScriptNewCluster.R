...
POI_Social     <- c("alpha_add",
                    "rho","UncertaintyMulti","UncertaintyMulti_Risk","log_lik","gamble_Pred","y_pred","kappa")
...
#for(i in 2:5){## bc sth is wrong with the tardis i do it over here. 
 # bashInput=i
  ...
  saveRDS(object = ModelFit3,file = paste0("../C_ModelFits/GeneralBetaFit_NewPreds_Age_",Agegroups[as.numeric(bashInput[1])],".rds"))
#}
