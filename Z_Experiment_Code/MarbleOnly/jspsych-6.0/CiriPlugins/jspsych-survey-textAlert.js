...
jsPsych.plugins['survey-textAlert'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'survey-textAlert',
    description: '',
    parameters: {
      questions: {
  ...
  plugin.trial = function(display_element, trial) {
	  function checkInpO(x)// to see that there are only numbers in the array
	  {
	      //var regex=/^[0-9]+$/;
	      if (!(x.length==7))
	      {
	          alert("Bitte einen 7-stelligen Code eingeben!");
	          return false;
	      }else return true;
	  }
