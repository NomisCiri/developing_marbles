		...
		for (t in 1:Tsubj[i]) {
		 ...
		 if(risk1Unc0[i, t]==1){// is it an uncertain trial?
			...
			// 	}
				...
				p_gamble_est[i,t] ~ beta((Sucess[i,t]*alpha_add[i]),(Fail[i,t]*beta_add[i])); // we know that the winning probability is beta distributed with the obtained shape parameters. 
