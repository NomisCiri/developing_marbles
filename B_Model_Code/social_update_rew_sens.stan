...
transformed data {
  int soc=1;// how many social social_info_risk2_safe1s
  ...
  int n_params=soc + unc;// number of parameters 
}
...
transformed parameters {
  ...
  for (ppt in 1:N){
    ...
    for (trial in 1:t_subj[ppt]){
      ...
      alpha[ppt][trial]+=psis[ppt]*social_trial[ppt,trial];
      // get updated mean
