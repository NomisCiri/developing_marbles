...
transformed data {
  ...
  int n_params=unc + unc;// number of parameters + 4 kappas
}
...
transformed parameters {
  ...
  for (ppt in 1:N){
    ...
    for (trial in 1:t_subj[ppt]){
      ...
      alpha[ppt][trial]+=psis[risk1_Unc2[ppt,trial]][ppt]*social_info_risky[ppt,trial]*social_trial[ppt,trial];
      beta[ppt][trial]+=psis[risk1_Unc2[ppt,trial]][ppt]*social_info_safe[ppt,trial]*social_trial[ppt,trial];
      // get updated mean
