    ...
    //check trials.
        ...
        real socialAlphaUnc;
  		  ...
  		  newBeta=pow(Fail[i,t],alpha_add[i]);
  			...
  			target+= generalized_beta_lpdf((EU_risky-EU_safe)| newAlpha,newBeta,0.00001,(U_risky));
  			choice[i, t] ~ bernoulli(generalized_beta_cdf((EU_risky-EU_safe), newAlpha,newBeta,0.00001,U_risky));// each choice is predicted as a bernoulli distributed random variable.
  		}//end Uncertain
